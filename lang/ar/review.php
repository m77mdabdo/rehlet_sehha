...
return [
    ...
    'withdraw_heading' => 'غيّرتي رأيك؟',
    'withdraw_body' => 'تقدري تسحبي موافقتك على النشر في أي وقت. رأيك هيتشال من الموقع، وهيفضل موجود عندنا إحنا بس.',
    'withdraw_action' => 'اسحبي الموافقة على النشر',
    'withdrawn_title' => 'اتسحبت',
    'withdrawn_body' => 'رأيك مابقاش هيظهر على الموقع. لو حابة تشيليه من عندنا خالص كمان، تقدري من صفحة ميعادك.',
