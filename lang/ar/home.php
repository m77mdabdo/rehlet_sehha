...
return [
    ...
    'stats' => [
        'title' => 'أرقام العيادة',
        'cases' => 'حالة اتعاملنا معاها',
        'years' => 'سنين في التغذية العلاجية',
        'rating' => 'تقييم المرضى',
        'support_days' => 'أيام متابعة في الأسبوع',
        'rating_suffix' => 'من 5',
    ],
    ...
    'how_it_works' => [
        ...
        'steps' => [
            'one' => [
                'title' => 'تحجزي موعدك',
                'body' => 'تختاري الباقة والميعاد اللي يناسبك، أونلاين أو في العيادة، وييجيلك تأكيد على واتساب.',
            ],
            'two' => [
                'title' => 'نفهم حالتك',
    ...
    'booking_cta' => [
        ...
        'cta' => 'احجزي موعدك',
        'note' => 'التأكيد بييجي على واتساب خلال ساعات المتابعة.',
    ],
