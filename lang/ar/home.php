...
return [
    ...
    'hero' => [
         ...
         */
        'beats' => [
            'talk' => 'الجلسة بتبدأ بأسئلة، مش بقايمة ممنوعات.',
            'write' => 'بنسمع الأول: أكلك، ويومك، واللي جربتيه قبل كده.',
            'notes' => 'وكل تغيير ليه سبب، وهتعرفي السبب.',
            'plan' => 'مش لازم تغيّري كل حاجة مرة واحدة. حاجة تثبت، وبعدين اللي بعدها.',
        ],
